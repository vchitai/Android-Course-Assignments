...
public class SampleAppRenderer {
    ...
    public void render()
    {
        ...
        for (int v = 0; v < viewList.getNumViews(); v++)
        {
            ...
            {
                Matrix44F vbProjectionMatrix = Tool.convert2GLMatrix(mRenderingPrimitives.getVideoBackgroundProjectionMatrix(viewID, COORDINATE_SYSTEM_TYPE.COORDINATE_SYSTEM_CAMERA));
